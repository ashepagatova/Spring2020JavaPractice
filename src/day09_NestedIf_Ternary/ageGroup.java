...
public class ageGroup {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ageGroup);
         ...
         boolean eligibeleToBuy = ageGroup == "Adult" || ageGroup == "Young Middle age Adult " ||
                 ageGroup ==" MIddle Age adult";


         if(eligibeleToBuy ){
             System.out.println("Your Eligible to buy ");

         } else{
             System.out.println(" YOur Not Eligible to buy");
         }
